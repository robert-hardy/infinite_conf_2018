# This is going to be done by manual steps, but just in case ...
...
do
	...
	if [ $EXIT_CODE -eq 0 ]; then
		...
		ssh ubuntu@$host wget https://archive.apache.org/dist/spark/spark-2.2.0/spark-2.2.0-bin-hadoop2.7.tgz
	fi
